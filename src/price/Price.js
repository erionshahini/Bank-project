          ...
          <div className='col-lg-4 col-md-6'>
            <div className='single-price text-center'>
              ...
              <ul className='pricing-list'>
                ...
                <li>
                  <Link to={'/services'}>Add up to 10 Users</Link>
                </li>
                <li>
          ...
          <div className='col-lg-4 col-md-6'>
            <div className='single-price text-center'>
              ...
              <ul className='pricing-list'>
                ...
                <li>
                  <Link to={'/services'}>Add up to 15 Users</Link>
                </li>
                <li>
                  <Link to={'/services'}>Free Internet Banking</Link>
                </li>
          ...
          <div className='col-lg-4 col-md-6'>
            <div className='single-price text-center'>
              ...
              <div className='pricing-details'>
                ...
                <h6 className='pricing-subtitle'>For a month</h6>
                <h4 className='pricing-title'>Advanced</h4>
              </div>
              <ul className='pricing-list'>
                <li>
                ...
                <li>
                  <Link to={'/services'}>Add up to 20 Users</Link>
                </li>
                <li>
                  <Link to={'/services'}>Free Internet Banking</Link>
                </li>
